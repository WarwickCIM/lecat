...
#' Each category should have one row per category and _at least_ one query term.
#'
#' @param wide_lexicon Data frame with one row per category containing type, category and the corresponding query terms.
